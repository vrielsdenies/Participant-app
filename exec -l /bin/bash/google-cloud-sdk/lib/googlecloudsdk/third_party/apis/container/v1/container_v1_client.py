...
depending on policies defined by GKE.
      ...
      Args:
        request: (ContainerMainProjectsLocationsAuditPolicyRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
    ...
    AuditPolicy.method_config = lambda: base_api.ApiMethodInfo(
        http_method=u'POST',
        method_id=u'container.mainProjects.locations.auditPolicy',
        ordered_params=[u'mainProjectId', u'location', u'projectNumber', u'clusterId'],
        path_params=[u'clusterId', u'location', u'mainProjectId', u'projectNumber'],
        query_params=[],
        relative_path=u'v1/mainProjects/{mainProjectId}/locations/{location}/{projectNumber}/{clusterId}/auditPolicy',
        request_field=u'checkAuditPolicyRequest',
        request_type_name=u'ContainerMainProjectsLocationsAuditPolicyRequest',
